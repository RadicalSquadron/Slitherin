...
//  Slitherin
//
//  Created by iOS Developer on 03/08/18.
...
class GameScene: SKScene {
    ...
    private func InitializeGameView() {
        ...
        let height = frame.size.height - 237
    ...
    private func initializeMenu(){
        ...
        //game title
        gameLogo = SKLabelNode(fontNamed: "Futura Medium")
        gameLogo.zPosition = 1
        gameLogo.position = CGPoint(x:0, y: (frame.size.height / 2) - 200)
        gameLogo.fontSize = 60
        gameLogo.text = "Slitherin..!"
        ...
        bestScore.position = CGPoint(x:0, y:gameLogo.position.y - 80)
        bestScore.fontSize = 40
        bestScore.text = "Top Score: \(UserDefaults.standard.integer(forKey: "bestScore"))"
